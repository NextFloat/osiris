...
function downloadFile(url, fileextension = null) {
  ...
  const filePath =
    `downloads/${fileName}` + (fileextension ? `.${fileextension}` : "");
        ...
        case "Message":
          ...
          try {
            if (Message.content.match(/\b(http|https)?(:\/\/)?\S+\.\S+\b/gi)) {
              let urls = Message.content.match(
                /\b(http|https)?(:\/\/)?\S+\.\S+\b/gi,
              );
              urls.forEach((url) => {
            ...
            if (
              ...
              Message.attachments.forEach((attachment) => {
                ...
                attachmenturl =
                  "https://autumn.revolt.chat/attachments/" + attachmentid;
                ...
                fileextension = contenttype.substring(
