...
function Login(Email, Password) {
    return new Promise((resolve, reject) => {
        axios({
            ...
            data: { "email": Email, "password": Password, "friendly_name": "Revolt.js Selfbot for Revolt.chat (https://github.com/DisECtRy/osiris)" },
            headers: {
                Host: 'api.revolt.chat',
                Connection: 'keep-alive',
                'Content-Length': { "email": Email, "password": Password, "friendly_name": "Revolt.js Selfbot for Revolt.chat (https://github.com/DisECtRy/osiris)" }.length,
